...
class MNISTDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self, *args, **kwargs):
        mnist_train = MNIST(self.dataset_root, train=True, download=False, transform=self.transform)
    ...
    def val_dataloader(self, *args, **kwargs):
        mnist_val = MNIST(self.dataset_root, train=False, download=False, transform=self.transform)
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument("--num_workers", type=int, default=4, help="number of processes for dataloader")
        parser.add_argument("--dataset_root", type=str, default="./dataset", help="root path of dataset")
        return parser
